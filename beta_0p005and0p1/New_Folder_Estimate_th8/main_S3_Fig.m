...
clear
%% check
load('estimate_S2.mat')
load('estimate_S3.mat')
...
%% th value of each evolution trajetory
% clear
% FileName = ['estimate_W3'];
% load(FileName)
% figure
% plot(1:num_new,th_sim_new,'o-')
% xlabel('i-th evolution trajectory')
% ylabel('th of estimator')
